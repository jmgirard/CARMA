function [success] = cell2csv(fileName, cellArray, separator, excelYear, decimal)
...
% updated cellArray and isempty functions, 04/2013, J.Simon
% added try-catch-end for fopen() and success output, 05/2014, J.Girard
