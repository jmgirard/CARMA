...
function push_submit_Callback(hObject,~)
    ...
    if isnan(get(handles.text_axis_steps,'string')) || get(handles.text_axis_steps,'string')<=1 || ceil(get(handles.text_axis_steps,'string'))~=floor(get(handles.text_axis_steps,'string'))
