...
%   License: https://github.com/jmgirard/CARMA/blob/master/license.txt
    ...
    handles.button_axis_color3 = uicontrol(handles.panel_scale, ...
        ...
        'Callback',@button_axis_color_Callback);
    % Create input method popup menu
    uicontrol(handles.panel_scale, ...
        'Style','text', ...
        'Units','normalized', ...
        'Position',[c1*2 r1 1-c1*4 2*h/3], ...
        'String','Rating Device and Colors:', ...
        'HorizontalAlign','center');
    handles.popup_input = uicontrol(handles.panel_scale, ...
        'Units','normalized', ...
        'Position',[c1*2 r2 1-c1*4 h], ...
        'Style','popupmenu', ...
        'String',{'Computer Mouse','USB Joystick'});
...
function Settings = get_settings(handles)
    ...
    input_options = get(handles.popup_input,'String');
    input_selected = get(handles.popup_input,'Value');
    Settings.input = input_options{input_selected};
end
